...
CREATE OR REPLACE VIEW analytics.customer_summary
...
FROM
    core.customers c
LEFT JOIN
        core.customer_types ct ON c.customer_type_id = ct.customer_type_id
LEFT JOIN
        core.customer_status cs ON c.status_id = cs.status_id
LEFT JOIN
        core.accounts a ON c.customer_id = a.customer_id AND a.status_id = 1
...
CREATE OR REPLACE VIEW analytics.account_details
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
AS
SELECT
    a.account_id,
...
JOIN
        core.account_status ast ON a.status_id = ast.status_id
LEFT JOIN
        core.branches b ON a.branch_id = b.branch_id
LEFT JOIN
        core.transactions t ON a.account_id = t.account_id
    AND t.transaction_date >= CURRENT_DATE() - INTERVAL '30 days' !!!RESOLVE EWI!!! /*** SSC-EWI-0073 - PENDING FUNCTIONAL EQUIVALENCE REVIEW FOR 'INTERVAL FORMAT' NODE ***/!!!
...
--** SSC-FDM-0007 - MISSING DEPENDENT OBJECT "DATE_TRUNC" **
CREATE OR REPLACE VIEW analytics.transaction_analysis
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
AS
SELECT
...
FROM
    core.transactions t
JOIN
        core.transaction_types tt ON t.transaction_type_id = tt.transaction_type_id
WHERE t.transaction_date >= CURRENT_DATE() - INTERVAL '2 years'
GROUP BY
    DATE_TRUNC('month', t.transaction_date), tt.type_name
ORDER BY transaction_month DESC, transaction_count DESC;

-- Loan and Credit Views
-- 4. Loan Portfolio View
CREATE OR REPLACE VIEW loans.loan_portfolio_summary
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
AS
SELECT
    lp.product_name,
    ...
    ROUND(COUNT(CASE WHEN l.delinquency_status != 'CURRENT' THEN 1 END)::DECIMAL / NULLIF(COUNT(l.loan_id), 0) * 100, 2
    ) AS delinquency_rate_percent
FROM
    loans.loans l
JOIN
        loans.loan_products lp ON l.loan_product_id = lp.loan_product_id
WHERE l.loan_status = 'ACTIVE'
GROUP BY lp.product_name, lp.loan_type
ORDER BY outstanding_balance DESC;

-- 5. Delinquency Report View
CREATE OR REPLACE VIEW loans.delinquency_report
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
AS
SELECT
    l.loan_number,
...
FROM
    loans.loans l
JOIN
        core.customers c ON l.customer_id = c.customer_id
JOIN
        loans.loan_products lp ON l.loan_product_id = lp.loan_product_id
LEFT JOIN
        loans.delinquency_tracking dt ON l.loan_id = dt.loan_id
...
CREATE OR REPLACE VIEW trading.portfolio_performance
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
AS
SELECT
    p.portfolio_id,
...
JOIN
        core.customers c ON p.customer_id = c.customer_id
LEFT JOIN
        trading.holdings h ON p.portfolio_id = h.portfolio_id
...
--** SSC-FDM-0007 - MISSING DEPENDENT OBJECT "DATE_TRUNC" **
CREATE OR REPLACE VIEW trading.trading_activity
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
AS
SELECT
...
FROM
    trading.trades t
JOIN
        trading.securities s ON t.security_id = s.security_id
JOIN
        trading.security_types st ON s.security_type_id = st.security_type_id
JOIN
        trading.exchanges e ON s.exchange_id = e.exchange_id
WHERE t.trade_date >= CURRENT_DATE() - INTERVAL '90 days' !!!RESOLVE EWI!!! /*** SSC-EWI-0073 - PENDING FUNCTIONAL EQUIVALENCE REVIEW FOR 'INTERVAL FORMAT' NODE ***/!!!
GROUP BY
    DATE_TRUNC('day', t.trade_date), s.symbol, s.security_name,
         st.type_name, e.exchange_name, t.side
ORDER BY trade_date DESC, total_value DESC;

-- Risk Management Views
-- 8. Risk Exposure View
CREATE OR REPLACE VIEW risk.risk_exposure_summary
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
AS
SELECT
    rm.entity_type,
...
FROM
    risk.risk_measurements rm
JOIN
        risk.risk_factors rf ON rm.risk_factor_id = rf.risk_factor_id
JOIN
        risk.risk_categories rc ON rf.risk_category_id = rc.risk_category_id
LEFT JOIN
        risk.risk_limits rl ON rm.entity_type = rl.entity_type
    AND rm.entity_id = rl.entity_id AND rm.risk_factor_id = rl.risk_factor_id
LEFT JOIN
        risk.risk_limit_breaches rlb ON rl.risk_limit_id = rlb.risk_limit_id
WHERE rm.measurement_date >= CURRENT_DATE() - INTERVAL '90 days' !!!RESOLVE EWI!!! /*** SSC-EWI-0073 - PENDING FUNCTIONAL EQUIVALENCE REVIEW FOR 'INTERVAL FORMAT' NODE ***/!!!
GROUP BY rm.entity_type, rf.factor_name, rc.category_name
ORDER BY average_exposure DESC;

-- 9. Credit Risk Dashboard
CREATE OR REPLACE VIEW risk.credit_risk_dashboard
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
AS
SELECT
    cr.entity_type,
...
--** SSC-FDM-0007 - MISSING DEPENDENT OBJECT "DATE_TRUNC" **
CREATE OR REPLACE VIEW compliance.aml_alerts_dashboard
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
AS
SELECT
    ...
    ROUND(COUNT(CASE WHEN aa.false_positive = TRUE THEN 1 END)::DECIMAL / NULLIF(COUNT(*), 0) * 100, 2
    ) AS false_positive_rate,
    AVG(EXTRACT(DAYS FROM aa.closed_date - aa.alert_date) !!!RESOLVE EWI!!! /*** SSC-EWI-0073 - PENDING FUNCTIONAL EQUIVALENCE REVIEW FOR 'EXTRACT' NODE ***/!!!) AS avg_resolution_days
FROM
    compliance.aml_alerts aa
WHERE aa.alert_date >= CURRENT_DATE() - INTERVAL '2 years'
GROUP BY
    DATE_TRUNC('month', aa.alert_date), aa.alert_type, aa.alert_priority
ORDER BY alert_month DESC, alert_count DESC;

-- 11. Regulatory Compliance Status
CREATE OR REPLACE VIEW compliance.compliance_status
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
AS
SELECT
    reg.regulation_name,
    ...
    ROUND(COUNT(CASE WHEN cm.status = 'COMPLIANT' THEN 1 END)::DECIMAL / NULLIF(COUNT(cm.monitoring_id), 0) * 100, 2
    ) AS compliance_rate_percent,
    MAX(cm.monitoring_date) AS last_check_date,
    MIN(cm.due_date) AS next_due_date
FROM
    compliance.compliance_monitoring cm
JOIN
        compliance.compliance_requirements cr ON cm.requirement_id = cr.requirement_id
JOIN
        compliance.regulations reg ON cr.regulation_id = reg.regulation_id
JOIN
        compliance.regulatory_authorities ra ON reg.authority_id = ra.authority_id
...
--** SSC-FDM-0007 - MISSING DEPENDENT OBJECT "DATE_TRUNC" **
CREATE OR REPLACE VIEW analytics.profitability_analysis
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
AS
SELECT
...
CREATE OR REPLACE VIEW analytics.branch_performance
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
AS
SELECT
    b.branch_id,
    ...
    COUNT(DISTINCT CASE WHEN acc.opening_date >= CURRENT_DATE() - INTERVAL '30 days' !!!RESOLVE EWI!!! /*** SSC-EWI-0073 - PENDING FUNCTIONAL EQUIVALENCE REVIEW FOR 'INTERVAL FORMAT' NODE ***/!!!
          THEN acc.account_id END) AS new_accounts_last_30_days,
    COUNT(DISTINCT e.employee_id) AS employee_count
FROM
    core.branches b
LEFT JOIN
        core.cities c ON b.city_id = c.city_id
LEFT JOIN
        core.states s ON c.state_id = s.state_id
LEFT JOIN
        core.accounts acc ON b.branch_id = acc.branch_id AND acc.status_id = 1
LEFT JOIN
        loans.loans l ON b.branch_id = l.branch_id AND l.loan_status = 'ACTIVE'
LEFT JOIN
        core.employees e ON b.branch_id = e.branch_id AND e.is_active = TRUE
...
--** SSC-FDM-0007 - MISSING DEPENDENT OBJECT "DATE_TRUNC" **
CREATE OR REPLACE VIEW analytics.product_performance_summary
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
AS
SELECT
    pp.product_id,
...
FROM
    analytics.product_performance pp
JOIN
        core.products p ON pp.product_id = p.product_id
JOIN
        core.product_categories pc ON p.category_id = pc.category_id
...
CREATE OR REPLACE VIEW analytics.operational_metrics
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
AS
SELECT
    measurement_date,
...
FROM
    audit.database_performance
WHERE metric_date >= CURRENT_DATE() - INTERVAL '30 days' !!!RESOLVE EWI!!! /*** SSC-EWI-0073 - PENDING FUNCTIONAL EQUIVALENCE REVIEW FOR 'INTERVAL FORMAT' NODE ***/!!!
ORDER BY measurement_date DESC;

-- 16. Customer Segmentation View
CREATE OR REPLACE VIEW analytics.customer_segmentation
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
AS
SELECT
    segment,
    ...
    AVG(churn_probability) AS avg_churn_probability,
    AVG(cross_sell_propensity) AS avg_cross_sell_propensity,
    ROUND(COUNT(*)::DECIMAL / (SELECT
        COUNT(*) FROM
        analytics.customer_analytics
    ) * 100, 2) AS segment_percentage
FROM
    analytics.customer_analytics ca
WHERE analysis_date = (SELECT
        MAX(analysis_date) FROM
        analytics.customer_analytics
    )
GROUP BY segment
...
--** SSC-FDM-0007 - MISSING DEPENDENT OBJECT "DATE_TRUNC" **
CREATE OR REPLACE VIEW compliance.transaction_monitoring
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
AS
SELECT
...
FROM
    core.transactions t
LEFT JOIN
        compliance.sanctions_screening ss ON ss.entity_type = 'TRANSACTION'
    AND ss.entity_id = t.transaction_id
LEFT JOIN
        compliance.aml_alerts aa ON aa.transaction_id = t.transaction_id
WHERE t.transaction_date >= CURRENT_DATE() - INTERVAL '90 days' !!!RESOLVE EWI!!! /*** SSC-EWI-0073 - PENDING FUNCTIONAL EQUIVALENCE REVIEW FOR 'INTERVAL FORMAT' NODE ***/!!!
GROUP BY
    DATE_TRUNC('day', t.transaction_date)
ORDER BY transaction_date DESC;

-- 18. Interest Rate Risk View
CREATE OR REPLACE VIEW treasury.interest_rate_risk_summary
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
AS
SELECT
    measurement_date,
...
SELECT
    ...
    ROUND(COUNT(CASE WHEN la.decision = 'APPROVED' THEN 1 END)::DECIMAL / NULLIF(COUNT(CASE WHEN la.decision IS NOT NULL THEN 1 END), 0) * 100, 2
    ) AS approval_rate,
    AVG(la.decision_date - la.application_date) AS avg_processing_days
FROM
    loans.loan_applications la
JOIN
        loans.loan_products lp ON la.loan_product_id = lp.loan_product_id
WHERE la.application_date >= CURRENT_DATE() - INTERVAL '2 years'
GROUP BY
    DATE_TRUNC('month', la.application_date), lp.product_name, lp.loan_type
ORDER BY application_month DESC, total_applications DESC;

-- 20. Executive Dashboard View
--** SSC-FDM-0007 - MISSING DEPENDENT OBJECT "DATE_TRUNC" **
CREATE OR REPLACE VIEW analytics.executive_dashboard
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
AS
SELECT
    ...
    ) !!!RESOLVE EWI!!! /*** SSC-EWI-0073 - PENDING FUNCTIONAL EQUIVALENCE REVIEW FOR 'jsonb_build_object' NODE ***/!!! AS metrics
UNION ALL
SELECT
