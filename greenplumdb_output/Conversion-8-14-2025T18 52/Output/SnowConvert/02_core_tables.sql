...
USE SCHEMA core /*, public*/;

-- 1. Countries
CREATE TABLE core.countries (
    country_id INTEGER PRIMARY KEY IDENTITY,
...
CREATE TABLE core.states (
    state_id INTEGER PRIMARY KEY IDENTITY,
...
CREATE TABLE core.cities (
    city_id INTEGER PRIMARY KEY IDENTITY,
...
CREATE TABLE core.exchange_rates (
    exchange_rate_id INTEGER PRIMARY KEY IDENTITY,
...
--** SSC-FDM-GP0001 - THE PERFORMANCE OF THE CLUSTER BY MAY VARY COMPARED TO THE PERFORMANCE OF DISTRIBUTED BY **
CLUSTER BY (exchange_rate_id)
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
;

-- 6. Customer Types
CREATE TABLE core.customer_types (
    customer_type_id INTEGER PRIMARY KEY IDENTITY,
...
CREATE TABLE core.customers (
    ...
    date_of_birth DATE,
    gender CHAR(1)
                   !!!RESOLVE EWI!!! /*** SSC-EWI-0035 - CHECK STATEMENT NOT SUPPORTED ***/!!! CHECK (gender IN ('M', 'F', 'O')),
    ssn_encrypted TEXT,
    tax_id VARCHAR(50),
    email VARCHAR(255),
    phone VARCHAR(20),
...
CREATE TABLE core.branches (
    branch_id INTEGER PRIMARY KEY IDENTITY,
...
CREATE TABLE core.account_types (
    account_type_id INTEGER PRIMARY KEY IDENTITY,
...
CREATE TABLE core.accounts (
    account_id INTEGER PRIMARY KEY IDENTITY,
...
CREATE TABLE core.account_joint_holders (
    joint_holder_id INTEGER PRIMARY KEY IDENTITY,
...
--** SSC-FDM-GP0001 - THE PERFORMANCE OF THE CLUSTER BY MAY VARY COMPARED TO THE PERFORMANCE OF DISTRIBUTED BY **
CLUSTER BY (transaction_type_id)
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
;
...
CREATE TABLE core.transaction_legs (
    leg_id INTEGER PRIMARY KEY IDENTITY,
...
CREATE TABLE core.gl_accounts (
    gl_account_id INTEGER PRIMARY KEY IDENTITY,
    account_code VARCHAR(20) NOT NULL UNIQUE,
    account_name VARCHAR(100) NOT NULL,
    account_type VARCHAR(20) NOT NULL
                                      !!!RESOLVE EWI!!! /*** SSC-EWI-0035 - CHECK STATEMENT NOT SUPPORTED ***/!!! CHECK (account_type IN ('ASSET', 'LIABILITY', 'EQUITY', 'REVENUE', 'EXPENSE')),
    parent_account_id INTEGER REFERENCES core.gl_accounts (gl_account_id),
    level INTEGER DEFAULT 1,
    is_leaf BOOLEAN DEFAULT TRUE,
    normal_balance VARCHAR(10)
                               !!!RESOLVE EWI!!! /*** SSC-EWI-0035 - CHECK STATEMENT NOT SUPPORTED ***/!!! CHECK (normal_balance IN ('DEBIT', 'CREDIT')),
    current_balance DECIMAL(18,2) DEFAULT 0,
    is_active BOOLEAN DEFAULT TRUE,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP()
)
--** SSC-FDM-GP0001 - THE PERFORMANCE OF THE CLUSTER BY MAY VARY COMPARED TO THE PERFORMANCE OF DISTRIBUTED BY **
CLUSTER BY (gl_account_id)
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
;

-- 20. GL Transactions
CREATE TABLE core.gl_transactions (
    gl_transaction_id INTEGER PRIMARY KEY IDENTITY,
...
--** SSC-FDM-GP0001 - THE PERFORMANCE OF THE CLUSTER BY MAY VARY COMPARED TO THE PERFORMANCE OF DISTRIBUTED BY **
CLUSTER BY (gl_transaction_id)
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 16,  "patch": "1.0" }, "attributes": {  "component": "greenplum",  "convertedOn": "08/14/2025",  "domain": "snowflake" }}'
;

-- 21. GL Transaction Details
CREATE TABLE core.gl_transaction_details (
    detail_id INTEGER PRIMARY KEY IDENTITY,
...
CREATE TABLE core.customer_products (
    customer_product_id INTEGER PRIMARY KEY IDENTITY,
    customer_id INTEGER REFERENCES core.customers (customer_id),
